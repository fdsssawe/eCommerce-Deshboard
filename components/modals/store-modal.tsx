...
export const StoreModal = () => {
    ...
    return(
    <Modal title="Crete store" description="Create new store or categories" isOpen={storeModal.isOpen} onClose={storeModal.onClose}>
        <div>
            <div className="space-y-4 py-2 pb-5">
                <Form {...form}>
